...
$sql = "SELECT * FROM transactions WHERE user_email = ? ORDER BY transaction_date DESC";
...
<tbody>
    <?php if ($result->num_rows > 0): ?>
        ...
        <tr>
            ...
            <td>
                <span class="badge <?php echo ($row['transaction_type'] == 'Deposit') ? 'bg-success' : 'bg-danger'; ?>">
           ...
           <td><?php echo htmlspecialchars($row['category']); ?></td>
            <td>
                <a class='btn btn-sm btn-primary' href='delete_transaction.php?id=<?php echo $row['transaction_id']; ?>'>
